...
class ContestForm(CVEBase):
    ...
    aps = AccessPoints(title="Wireless AP", description="If you require your own wireless access point (we don't provide hardware), we need the details to give on to the DEF CON NOC. 5 Ghz long Wireless AC and N is the only allowable spec on the Contest floor", default=list())
    ...
    blackbadge_consideration = colander.SchemaNode(colander.String(), title="Blackbadge", description="Why should your contest be considered for a black badge? If you don't want your contest to be considered for black badge, leave this blank.", missing='')
