...
<li>We will have a pre-con contest meeting Thursday morning for the contest and event Points Of Contact (POCs). You need to be there, and if you absolutely can't attend, you will need to let the CnE head (Pyr0) know well in advance. This meeting is where we will discuss any last minute changes, introduce you to the goon staff, set ground rules, and get you your contest badges. If you fail to attend this meeting or you don't let CnE head (Pyr0) know that you will be absent your contest or event will be cancelled and your space awarded to one of the many people who would be happy to have it.</li>

<li>Please fill out the entire form. If there are additional requests, favors owed, comments or other important commitments, please let me know when you submit this form. Please be thorough, and complete.</li>
...
<li>New this year is that there will be two seperate closing ceremonies, one will be held for Contests and Events that do not have black badge status, and then the main closing ceremonies. We are attempting to limit the length of the closing ceremonies, and want to still provide the recognition that everyone deservers</li>
